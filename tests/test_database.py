...
class DatabaseTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_tab_template = PngImageFile(os.path.join(self.directory, 'data/buttons/chrome/new_tab_template_chrome.png'))
        ...
        self.new_win_template = PngImageFile(os.path.join(self.directory, 'data/buttons/chrome/new_windows_template_chrome.png'))
